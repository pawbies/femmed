...
[
  {
    ...
    labeler: l("Novartis"),
    form: f("Capsule"),
    release_type: :bimodal, delay: 4.0,
  ...
  },
  {
    ...
    labeler: l("Shire"),
    form: f("Capsule"),
    release_type: :extended, release_duration: 12.0,
    categories: [ c("Psychopharmaca"), c("Stimulants") ],
  ...
  },
  {
    ...
    labeler: l("Pfizer"),
    form: f("Capsule"),
    release_type: :extended, release_duration: 24.0,
    categories: [ c("Antidepressants"), c("Psychopharmaca"), c("Anxiolytics") ],
  ...
  medication = Medication.find_or_create_by(name: m[:name]) do |med|
    ...
    med.notes              = m[:notes]
    med.release_type       = m[:release_type]
    med.delay              = m[:delay]
    med.release_duration   = m[:release_duration]
  end
